package com.nusantarian.simplealarm.service
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        val VIBRATE_INTERVAL = longArrayOf(1000, 1000, 1000, 1000, 1000)
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val title =
            if (type.equals(TYPE_ONE_TIME, ignoreCase = true)) TYPE_ONE_TIME
            else TYPE_REPEATING
        val notifId =
    ...
    private fun showAlarmNotification(
        ...
        if (Build.VERSION.SDK_INT >= 27) {
            ...
            channel.vibrationPattern = VIBRATE_INTERVAL
